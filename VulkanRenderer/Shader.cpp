...
bool Shader::load(const std::string& vertexPath, const std::string& fragPath)
{
	...
	if (VertexShaderStream.is_open()) {
		...
		std::cout << "Couldn't read file: " << vertexPath << std::endl;
		getchar();
		return 0;
	}
...
{
	GLuint floatId = glGetUniformLocation(programId, name.c_str());
	glUniform1f(floatId, value);
}

void Shader::setVec3(const std::string& name, glm::vec3 vec)
{
	GLuint vecId = glGetUniformLocation(programId, name.c_str());
